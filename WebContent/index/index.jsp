...
<body>
    ...
    %>
    	<br />您好，&nbsp;&nbsp;<%=user %>&nbsp;先生/小姐，&nbsp;欢迎回来！&nbsp;&nbsp;<a href ="/blog233/logon.jsp">退出</a>
	</div>
	<hr />
	<!-- end #logo -->
	<div id="header">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">欢迎您 </a></h2>
				<p class="meta">好友动态</p>
				<div class="entry">
<%
...
<c:forEach items="${requestScope.blogs}" var="b">
             ...
             <div class="news"> <c:out value="${b.lname }"></c:out>
                 ...
                 <c:choose>
                  ...
                  <a href="/blog233/servlet/EditTalk?nid=${b.lid}">评论</a>&nbsp;&nbsp;<a href="#">删除</a>
                  	</c:when>
                  	<c:otherwise>
               ...
               <p></p>
                               <b>评论：</b>
				 <c:out value="${b.views }"></c:out>
               
</c:forEach>
		 

					<div><a href="/blog233/servlet/ListTalk" class="links">更多动态</a></div>
